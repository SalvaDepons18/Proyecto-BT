              ...
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" action="../controllers/controllers_torneos.php">
                        <div class="form-group">
                            <label for="exampleInputEmail1">ID del torneo</label>
                            <input type="number" class="form-control" name="ide" placeholder="ID de torneo a eliminar..." required>
                        </div>
