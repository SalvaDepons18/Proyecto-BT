    ...
    <div class="container pt-5">
        ...
        <div class="d-flex flex-column text-center mb-5">
          ...
          <div id="barrabusqueda">
            <form method="post" action="../controllers/controllers_jugadores.php">
                <input id="buscarjugador" type="text" name="ci" placeholder="Buscar jugador por CI..."/>
                <input id="ingresarjugador" type="submit" name="buscarj" value="Buscar"/>
            </form>
        </div>
        <br>
        <br>
