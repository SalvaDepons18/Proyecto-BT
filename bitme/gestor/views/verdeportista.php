          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                  <h3 class="card-title">LISTADO DE DEPORTISTAS</h3>
                    ...
                    <div class="form-group">
                        ...
                        <?php
                          ...
                          foreach ($deportistas as $nombre) {
                            echo "<tr> <td>".$nombre['ci']."</td>
                                <td>".$nombre['nombre']."</td>
                                <td>".$nombre['apellido']."</td>
                                <td>".$nombre['edad']."</td>
                                <td>".$nombre['fecha_ficha_medica']."</td>
                                <td>".$nombre['numero_camiseta']."</td>
                                <td>".$nombre['id_institucion']."</td></tr>";
                          } 
                          ?>
                          </table>
                        </div>
          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h3 class="card-title">CON FICHA MEDICA VENCIDA</h3>
                    <form class="forms-sample" method="post" action="../controllers/controllers_deportista.php">
                        <br>
                        <div class="form-group">
