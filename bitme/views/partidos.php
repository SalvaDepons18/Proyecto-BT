...
<body class="bg-white">
    ...
    <div class="container-fluid page-headerf mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5"
            ...
            <h4 class="display-4 mb-3 mt-0 mt-lg-5 text-white text-uppercase font-weight-bold">Partidos</h4>
            <div class="d-inline-flex">
                <p class="m-0 text-white">Inicio</p>
                <p class="m-0 text-white px-2">/</p>
                <p class="m-0 text-white">Partidos</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
    ...
    <div class="container pt-5">
        ...
        <div class="d-flex flex-column text-center mb-5">
            <h4 class="text-primary font-weight-bold">Partidos</h4>
            <h4 class="display-4 font-weight-bold">La información más actualizada</h4>
        </div>

            <!-- BARRA DE BUSQUEDA -->
    <div id="barrabusqueda">
    <form method="post" action="../controllers/controllers_partidos.php">
            <input id="buscarpartido" type="text" name=id placeholder="Buscar partido por ID..."/>
            <input id="ingresarpartido" type="submit" name=buscar value="Buscar"/>
        </form>
    </div>
    <br>
    <br>
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                ...
                <div class="d-flex flex-column justify-content-start">
                    ...
                    <a class="text-white mb-2" href="../views/about.html"><i class="fa fa-angle-right mr-2"></i>¿Quiénes
                        somos?</a>
                    <a class="text-white" href="../views/contact.html"><i class="fa fa-angle-right mr-2"></i>Contacto</a>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
