        ...
        <div class="content-wrapper">
            <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h3 class="card-title">ELIMINAR PARTIDO</h3>
                    <form class="forms-sample" method="post" action="../controllers/controllers_partido.php">
                        <div class="form-group">
                            <label for="exampleInputEmail1">ID del equipo</label>
                            <input type="number" class="form-control" name="ide" placeholder="ID de partido a eliminar..." required>
                        </div>
