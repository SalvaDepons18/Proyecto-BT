          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h3 class="card-title">AGREGAR DEPORTISTAS</h3>
                    <form class="forms-sample" method="post" action="../controllers/controllers_deportista.php">
                      ...
                      <div class="form-group">
                        <label for="exampleInputConfirmPassword1">Fecha de vencimiento del carnet de salud</label>
                        <input type="date" class="form-control"  name="fecha" placeholder="Fecha de vencimiento..." required>
                      </div>
                      <div class="form-group">
                      <label for="exampleInputUsername1">Numero Camiseta</label>
                        <input type="number" class="form-control" name="num" placeholder="Numero Camiseta..." required>
                      </div>
                      <div class="form-group">
                      <label for="exampleInputUsername1">ID Institucion</label>
                        <input type="text" class="form-control" name="idi" placeholder="ID Institucion..." required>
                      </div>
