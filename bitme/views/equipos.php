...
<body class="bg-white">
    ...
    <div class="container-fluid page-headerf mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center pt-0 pt-lg-5"
            ...
            <h4 class="display-4 mb-3 mt-0 mt-lg-5 text-white text-uppercase font-weight-bold">Equipos</h4>
            <div class="d-inline-flex">
                <p class="m-0 text-white">Inicio</p>
                <p class="m-0 text-white px-2">/</p>
                <p class="m-0 text-white">Equipos</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
    ...
    <div class="container pt-5">
        ...
        <div class="d-flex flex-column text-center mb-5">
            <h4 class="text-primary font-weight-bold">Equipos</h4>
            <h4 class="display-4 font-weight-bold">La información más actualizada</h4>
        </div>

          <!-- BARRA DE BUSQUEDA -->
          <div id="barrabusqueda">
            <form method="post" action="../controllers/controllers_equipos.php">
                <input id="buscarpartido" type="text" name="ide" placeholder="Buscar equipo por ID..."/>
                <input id="ingresarpartido" type="submit" name="buscare" value="Buscar"/>
            </form>
        </div>
        <br>
        <br>
