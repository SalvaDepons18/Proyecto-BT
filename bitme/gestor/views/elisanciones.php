          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h3 class="card-title">ELIMINAR SANCIONES</h3>
                    <form class="forms-sample" method="post" action="../controllers/controllers_sanciones.php">
                        <div class="form-group">
                            <label for="exampleInputEmail1">ID de la Sancion</label>
                            <input type="number" class="form-control" name="ide" placeholder="ID de sancion a eliminar..." required>
                        </div>
