          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h3 class="card-title">ELIMINAR INSTITUCION</h3>
                    <form class="forms-sample" method="post" action="../controllers/controllers_instituciones.php">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="ide" placeholder="ID de institucion a eliminar..." required>
                        </div>
                     
                      <input type="submit" class="btn btn-primary mr-2" value="Eliminar" name="eliminar">
