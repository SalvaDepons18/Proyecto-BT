          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h3 class="card-title">AGREGAR DEPORTES</h3>
                    <form class="forms-sample" method="post" action="../controllers/controllers_deporte.php">
                      <div class="form-group">
                        <label for="exampleInputUsername1">Nombre</label>
                        <input type="text" class="form-control" id="exampleInputUsername1" name="nom" placeholder="Nombre del deporte a agregar..." required>
                      </div>
